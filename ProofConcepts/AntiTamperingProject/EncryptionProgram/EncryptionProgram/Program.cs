...
namespace EncryptionProgram
{
    class Program
    {
        ...
        private static byte[] DecryptionKeyStorage(byte[] AesKey)
        {
        ...
        private static byte[] DecryptionIVStorage(byte[] AesIV)
        {
        ...
        private static void EncryptionDBKeyStorage(byte[] AesKeyDB)
        {
        ...
        private static void EncryptionDBIVStorage(byte[] AesIVDB)
        {
        ...
        private static byte[] DecryptionDBKeyStorage()
        {
        ...
        private static byte[] DecryptionDBIVStorage()
        {
        ...
        private static void InitialEncryptFiles(string FilePath, byte[] AesKey, byte[] AesIV)
        {
        ...
        private static byte[] DecryptIntoMemory(string FilePath, byte[] AesKey, byte[] AesIV)
        {
        ...
        private static void EncryptFilesAgain(byte[] data, string FilePath, byte[] AesKey, byte[] AesIV)
        {
            byte[] EncryptedFileContents;
